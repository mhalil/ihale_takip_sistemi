...
class DetailWidget(QWidget):
    ...
    def setup_ui(self):
        ...
        btn_backup.setObjectName("WarningBtn")
        ...
        btn_col_settings.setObjectName("SecondaryBtn")
        ...
        self.table = QTableWidget(); self.table.setColumnCount(17)
        self.table.setAlternatingRowColors(True)
        self.table.setHorizontalHeaderLabels([
            "IKN", "Firma", "İhale Adı", "Sözl. Tarihi", "Parti", "Parti Tarihi",
            "Miktar", "Malzeme Detayı", "Tutar",
            "Ambar", "Test B.", "Test S.", "Rapor", "Kabul", "Ödeme",
            "Açıklama", "İşlem"
        ])
        ...
        self.table.setColumnWidth(15, 200)  # Aciklama
        self.table.setColumnWidth(16, 130)  # Islem
    ...
    def apply_filters(self):
        ...
        for row_idx, r in enumerate(filtered):
            ...
            # Durum sütunları (cols 9-14)
            for c, idx in enumerate([7, 8, 9, 10, 11, 13], 9):
            ...
            # Açıklama (col 15)
            self.table.setItem(row_idx, 15, QTableWidgetItem(str(r[14]) if len(r) > 14 else ""))

            # İşlem Butonları (col 16)
            ...
            self.table.setCellWidget(row_idx, 16, action_widget)
...
class AboutDialog(QDialog):
    ...
    def setup_ui(self):
        ...
        # Info Text
        info_text = """
        <h3 style='color: #6366f1; margin-bottom:0;'>İhale Takip Uygulaması v6.5</h3>
        <br>
